...
# this_text = 'Напишите абв напиабв програбвму, удаляющую изабв этого абв текста все вабвс лишниабве буквабвы'
#
# def delite_words(this_text):
#     this_text = list(filter(lambda x: 'абв' not in x, this_text.split()))
#     return " ".join(this_text)
# this_text = delite_words(this_text)
# print(this_text)
